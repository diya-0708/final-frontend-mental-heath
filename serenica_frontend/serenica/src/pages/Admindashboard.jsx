...
export default function AdminDashboard() {
  ...
  // ✅ useState hooks are now correctly INSIDE the component
    ...
    <div className="min-h-screen pb-20 font-body" style={{ background: '#f8fafc' }}>
      ...
      <div className="sticky top-0 z-40 bg-white border-b border-slate-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          {/* ✅ Buttons added here in the topbar */}
          <div className="flex items-center gap-2">
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Section title="Risk Distribution" subtitle="How many students fall into each risk category (all-time)">
            <RiskDistributionChart data={riskDist} />
          </Section>
          <Section title="New Student Registrations" subtitle="How many students joined each week over the last 12 weeks">
        ...
        {/* ── Charts row 2 ── */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Section title="Average Stress, Anxiety & Depression" subtitle="Platform-wide daily averages over the last 30 days (scale 1–10)">
            <AverageScoresChart data={avgScores} />
          </Section>
          <Section title="Students by Course" subtitle="Which programmes have the most registered students">
      ...
      {/* ✅ Modals rendered at the bottom of the component */}
    {showChangePassword && (
